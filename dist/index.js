...
class Parser {
    ...
    expect(token) {
        ...
        if (!this.current() || this.current().token !== token) {
            throw new Error(`Expected ${token} at line ${(_a = this.current()) === null || _a === void 0 ? void 0 : _a.location.line}`);
        }
        this.advance();
    }
    precedence(op) {
        ...
        return (_a = precs[op]) !== null && _a !== void 0 ? _a : 0;
    }
    parseUnary() {
        if (this.current() &&
    ...
    parseStatement() {
        ...
        const token = (_a = this.current()) === null || _a === void 0 ? void 0 : _a.token;
        if (token === "import") {
            this.advance();
        ...
        if (token === "func") {
            ...
            this.expect("(");
            const params = [];
            while (((_b = this.current()) === null || _b === void 0 ? void 0 : _b.token) !== ")") {
                ...
                if (((_c = this.current()) === null || _c === void 0 ? void 0 : _c.token) === ",")
                    this.advance();
            }
            this.expect(")");
            this.expect("=>");
            ...
            this.expect("{");
            const body = [];
            while (((_d = this.current()) === null || _d === void 0 ? void 0 : _d.token) !== "}") {
        ...
        if (token === "if") {
            ...
            this.expect("{");
            const then = [];
            while (((_e = this.current()) === null || _e === void 0 ? void 0 : _e.token) !== "}") {
        ...
        if (token === "while") {
            ...
            this.expect("{");
            const body = [];
            while (((_f = this.current()) === null || _f === void 0 ? void 0 : _f.token) !== "}") {
                body.push(this.parseStatement());
            }
            this.expect("}");
    ...
    inferType(expr) {
        ...
        switch (expr.kind) {
            case "literal":
                return expr.type;
            case "identifier":
                return ((_a = this.env.vars.get(expr.name)) === null || _a === void 0 ? void 0 : _a.type) || { kind: "primitive", primitive: "any" };
            case "binary":
                if (["==", "!=", "<", ">", "<=", ">=", "&&", "||"].includes(expr.op)) {
    ...
    evaluateExpression(expr) {
        switch (expr.kind) {
            ...
            case "member":
                ...
                return obj === null || obj === void 0 ? void 0 : obj[expr.property];
        }
    }
}
// ============================================================================
